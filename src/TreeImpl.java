...
public class TreeImpl<E extends Comparable<? super E>> implements Tree<E> {
    ...
    private class NodeAndParent {
        ...
        public NodeAndParent(Node<E> current, Node<E> parent, int depthLevel) {
    ...
    public boolean add(E value) {
        ...
        if (nodeAndParent.depthLevel > maxDepth) {
            return false; //Ограничение на максимальное количество уровней
        }
    ...
    private NodeAndParent doFind(E value) {
        ...
        int     depthLevel = 1; //Корень - 1 уровень

        while (current != null) {
            if (current.getValue().equals(value)) {
                return new NodeAndParent(current, previous, depthLevel);
            }
        ...
        return new NodeAndParent(null, previous, depthLevel);
    }
    ...
    public void display() {
        ...
        System.out.println("................................................................");
        System.out.println("Высота : " + getHeight() + "; Сбалансировано :" + isBalanced());
    ...
    private boolean isNodeBalanced(Node<E> node) {
        return (node == null) ||
                isNodeBalanced(node.getLeftChild()) &&
                        isNodeBalanced(node.getRightChild()) &&
